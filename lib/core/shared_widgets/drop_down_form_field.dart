...
class SharedDropDownFormFileds extends StatelessWidget {
  final List<DropdownMenuItem<String>> items;
  final String value;
  final Function(dynamic value) onChanged;

  const SharedDropDownFormFileds(
      {super.key,
      required this.items,
      required this.value,
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButtonFormField(
      ...
      style: theme.textTheme.titleMedium?.copyWith(color: AppColor.greyColor2),
      isExpanded: true,
      elevation: 3,
